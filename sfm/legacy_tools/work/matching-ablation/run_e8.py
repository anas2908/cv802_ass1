...
def main():
    ...
    if status_file.exists():
        raise FileExistsError(f'Preserving previous run: {status_file}')
    ...
    for stage, command in commands:
        ...
        if result.returncode:
            raise RuntimeError(f'{stage} failed; see {work}')
