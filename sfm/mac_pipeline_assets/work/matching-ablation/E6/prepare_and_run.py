...
def main():
 ...
 args=parser.parse_args();subjects=tuple(args.subjects)
 started=time.monotonic();prepared=prepare(subjects);summary={'experiment':'E6_guided_off','started_utc':stamp(),'subjects':{}}
