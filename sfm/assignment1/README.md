...
![COLMAP example](https://raw.githubusercontent.com/mbzuai-metaverse/CV802-starter-code/main/assignment1/assets/examples/colmap.gif)
...
This local implementation uses PyCOLMAP on the CPU. Installing the requirements
above provides the reconstruction backend; no separate COLMAP executable is needed.
The tested versions are NumPy 1.26.4, Open3D 0.19.0, and PyCOLMAP 4.2.0.
...
The reconstruction orchestration and result conversion can be checked without
a COLMAP installation using:
