...
person-mask projection rule using the current VGGSfM cameras and the verified
Mac masks bundled in `datasets/reviewed/mac_masks`.
...
remain below `/l/users/$USER/cv802_ass1-runs/vggsfm` by default. A later allocation reuses them.
